...
datapred<-read.csv("Chapter1_Screen_08_25_2022.csv")
Team<-c("Jonny")
...
metagear::abstract_screener("effort_Jonny.csv", aReviewer = "Jonny", titleColumnName = "Title", abstractColumnName = "Abstract")
